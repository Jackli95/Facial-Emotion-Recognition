...
import keras
from keras.layers import Input, Dense, Conv2D, BatchNormalization, RepeatVector, Multiply, Permute, Reshape
...
output3 = Conv2D(64, kernel_size=(3,3),activation=None)(output2)
...
model = Model(inputs=inputs,outputs=output6)

"""
model = Sequential()

model.add(Conv2D(32, kernel_size=(3, 3), activation=None, input_shape=(48,48,1)))
